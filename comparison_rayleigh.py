...
def readFile(list):
    for filename in list:
        ...
        try:
            ...
            mie_wind_validity = coda.fetch(product, 'rayleigh_hloswind', -1, 'windresult/validity_flag')
            ...
            ax.legend()
            plt.savefig('/work/marcus_mueller/aeolus/3082/plots/'+(x+delta).strftime("%Y-%m-%d")+'_rayleigh.png',dpi=150)
            plt.show()
        except:
            print("error")
